...
public class ListFilterItemStackMixin {
	...
	@WrapOperation(method = "<init>", at = @At(value = "FIELD", target = "Lcom/simibubi/create/content/logistics/filter/FilterItemStack$ListFilterItemStack;shouldRespectNBT:Z"), remap = false)
